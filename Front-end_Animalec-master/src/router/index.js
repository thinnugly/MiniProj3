...
const routes = [
  ...
  {
    path: '/admin/sponsorsanimals',
    name: 'sponsorAnimaisAssociados',
    component: () => import('@/views/sponsors_animals/ListSponsorAnimals.vue'),
  },
  {
    path: '/admin/sponsorsanimals/:sponsorAnimalId',
    name: 'editSponsorAnimal',
    component: () => import('@/views/sponsors_animals/EditSponsorAnimal.vue'),
  },
  {
    path: '/admin/expertsanimals',
    name: 'expertAnimaisAssociados',
    component: () => import('@/views/experts_animais/ListExpertAnimals.vue'),
  },
  {
    path: '/admin/expertsanimals/:expertAnimalId',
    name: 'editExpertAnimal',
    component: () => import('@/views/experts_animais/EditExpertAnimal.vue'),
  },
  {
    path: '/admin/experts',
    name: 'listExperts',
