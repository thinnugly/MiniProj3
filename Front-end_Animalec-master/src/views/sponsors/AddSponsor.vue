...
<script>
import { ADD_SPONSOR } from '@/store/sponsors/sponsor.constants'; // Alterei para ADD_SPONSOR
import HeaderPage from '@/components/HeaderPage.vue';
import router from '@/router';
import { mapGetters } from 'vuex';

export default {
  name: 'AddSponsor', // Alterei para AddSponsor
  components: {
    HeaderPage,
  },
  data: () => {
    return {
      ...
      errors: {
        ...
        contact: '',
        sponsorship_value: '',
        notes: '', // Incluindo a validação de notes
      },
    };
  },
  computed: {
    ...
    addSponsor() {
      ...
      this.$store.dispatch(`sponsor/${ADD_SPONSOR}`, this.sponsor).then(
        ...
        (err) => {
          ...
          // if (
          //   err.message !== 'Este patrocinador já está associado a este animal.'
          // ) {
